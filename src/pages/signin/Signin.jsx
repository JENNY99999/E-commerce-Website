            ...
            <main className='content'>
                <div className="auth-content">
                    ...
                    <div className="auth-no-account">
                        <span className="auth-info "><strong>Don't have an account?</strong></span>
                        <Link to='/signup'>
                            <Button className='button-small button-border-gray ' variant="light" type='submit'>Sign Up</Button>
                        </Link>
                    </div>
                </div >
            </main >
