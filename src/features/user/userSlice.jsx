...
export const emptyUserCart = createAsyncThunk("auth/emptycart", async (thunkAPI) => {
    try {
...
// //get user cart without authorization
// export const getACartNoAuth = createAsyncThunk("auth/getcart", async (thunkAPI) => {
//     try {
//         return await authService.getCartNoAuth()
//     } catch (error) {
//         return thunkAPI.rejectWithValue(error)
//         // console.log(error.response.data);
...
// //get user cart with authorization

// export const getACartWithAuth = createAsyncThunk("auth/getcart/auth", async (thunkAPI) => {
//     try {
//         return await authService.getCartWithAuth()
//     } catch (error) {
//         // return thunkAPI.rejectWithValue(error)
//         console.log(error.response.data);
...
//             .addCase(getACartWithAuth.pending, (state) => {
//                 state.isLoading = true;
//             })
//             .addCase(getACartWithAuth.fulfilled, (state, action) => {
//                 state.isLoading = false;
//                 state.isSuccess = true;
//                 state.isError = false;
//                 state.cart = action.payload;
//             })
//             .addCase(getACartWithAuth.rejected, (state, action) => {
//                 state.isLoading = false;
//                 state.isSuccess = false;
//                 state.isError = true;
//                 state.cart = [];
...
//             .addCase(getACartNoAuth.pending, (state) => {
//                 state.isLoading = true;
//             })
//             .addCase(getACartNoAuth.fulfilled, (state, action) => {
//                 state.isLoading = false;
//                 state.isSuccess = true;
//                 state.isError = false;
//                 state.cart = action.payload;
//             })
//             .addCase(getACartNoAuth.rejected, (state, action) => {
//                 state.isLoading = false;
//                 state.isSuccess = false;
//                 state.isError = true;
//                 state.cart = [];
